...
#define TEST_MAIN_TASK	3

#define TNUM_SEMID	9
#define APP_HEAP_SEM	1
#define SEMID_tSemaphore_SerialPortUART_F_ReceiveSemaphore	2
#define SEMID_tSemaphore_SerialPortUART_F_SendSemaphore	3
