...
static STK_T _kernel_stack_TEST_MAIN_TASK[COUNT_STK_T(STACK_SIZE)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(TestMainTask), INT_PRIORITY(MAIN_PRIORITY), {	(void *)(_kernel_stack_TEST_MAIN_TASK), 	((void *)((char *)(_kernel_stack_TEST_MAIN_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	PYBRICKS_TASK, TSKID_tTask_LogTask_Task, TEST_MAIN_TASK
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (0), (intptr_t)(0), (NFYHDR)(SIOTestCBRHandler), (1000), (0) }
};
