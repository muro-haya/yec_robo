...
char tSerialPortMain_SerialPortUART_F_SerialPortMain_CB_receiveBuffer_INIT[256];
char tSerialPortMain_SerialPortUART_F_SerialPortMain_CB_sendBuffer_INIT[256];
/* cell INIB #_INIB_# */
tSerialPortMain_INIB tSerialPortMain_INIB_tab[] = {
    /* cell: tSerialPortMain_CB_tab[0]:  SerialPortUART_F_SerialPortMain id=1 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        256,                                     /* receiveBufferSize */
        256,                                     /* sendBufferSize */
        tSerialPortMain_SerialPortUART_F_SerialPortMain_CB_receiveBuffer_INIT, /* receiveBuffer */
        tSerialPortMain_SerialPortUART_F_SerialPortMain_CB_sendBuffer_INIT, /* sendBuffer */
    },
};
...
extern const struct tag_tSerialPortMain_eSerialPort_DES SerialPortUART_F_SerialPortMain_eSerialPort_des;
const struct tag_tSerialPortMain_eSerialPort_DES SerialPortUART_F_SerialPortMain_eSerialPort_des = {
