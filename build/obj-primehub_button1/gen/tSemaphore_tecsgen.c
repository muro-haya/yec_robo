...
tSemaphore_INIB tSemaphore_INIB_tab[] = {
    /* cell: tSemaphore_CB_tab[0]:  SerialPortUART_F_ReceiveSemaphore id=1 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortUART_F_ReceiveSemaphore, /* id */
    },
    /* cell: tSemaphore_CB_tab[1]:  SerialPortUART_F_SendSemaphore id=2 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        SEMID_tSemaphore_SerialPortUART_F_SendSemaphore, /* id */
    },
